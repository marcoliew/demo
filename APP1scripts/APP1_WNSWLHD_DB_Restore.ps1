$SQLMigrate ="s3://dependencies-train-app1-sqlnativebackup/SQLMigrate"
...
$backupfilepath="arn:aws:s3:::dependencies-train-app1-sqlnativebackup/Restore/branch1/branch1_Titanium*"
$secretid="/dependencies-train-app1/sqldb/creds"
$DBINSTANCE="listener.sqldb-app1-train-001"
$endpoint="listener.sqldb-app1-train-001.cl5mkoytz7pw.ap-southeast-2.rds.amazonaws.com"
$TITANIUMMANAGERSERVERLOCATION = "https://APP1-AWS-WEB-branch1-Train.nswhealth.net"
$TITANIUMWEBSERVICESURL = "https://APP1-AWS-WEB-branch1-Train.nswhealth.net/titanium"
$TITANIUMWEBAPPLICATIONSURL = "https://APP1-AWS-WEB-branch1-Train.nswhealth.net/titanium/web"
$REPORTINGSERVICESSERVERURL = "http://cldrssrstAPP1vo/ReportServer"
$servername = $endpoint
$username = "Admin"
$DBPassword = (Get-SSMParameter -Name /dependencies-train-app1/database/password/master -WithDecryption $true).Value
$password = $DBPassword
$DBname = "Titanium_WNSW_train" 
