...
#$SQLAgJob1="$SQLScripts/SAgJob-WNSWDB-Backup.sql"
#$SQLAgJob2="$SQLScripts/SAgJob-FixMissingCoC.sql"
#$SQLAgJob3="$SQLScripts/SAgJob-MedicalHistoryRecordsUpdate-WNSW.sql"
$RowCheck="$SQLScripts/Migration-UserTableRowCountCheck.sql"
$backupfilepath="arn:aws:s3:::dependencies-prod-app1-sqlnativebackup/DB_Dump/branch1/branch1_titanium*"
...
#aws s3 cp $SQLAgJob3 'c:\Titanium\SAgJob-MedicalHistoryRecordsUpdate-WNSW.sql'
