...
$backupfile1 = "$src\branch1_Titanium1.bak"
$backupfile2 = "$src\branch1_Titanium2.bak" 
$backupfile3 = "$src\branch1_Titanium3.bak"
$backupfile4 = "$src\branch1_Titanium4.bak"
$dbname = 'branch1_Titanium'
