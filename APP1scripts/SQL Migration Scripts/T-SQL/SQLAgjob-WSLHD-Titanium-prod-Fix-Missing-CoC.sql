...
/****** Object:  Job [Titanium_WS_prod fix missing CoC]    Script Date: 18/10/2021 11:22:55 ******/
BEGIN TRANSACTION
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Titanium_WS_prod fix missing CoC', 
		@enabled=1, 
