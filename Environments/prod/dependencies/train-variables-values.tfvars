...
s3_buckets_list        = []
<<<<<<< HEAD:Environments/prod/dependencies/train-variables-values.tfvars
webhook_filter_branch  = "Production"
=======
webhook_filter_branch  = "Non-prod"
>>>>>>> b07c874f27f6b912c2e2cb57ab046b030cab8b15:Environments/train/dependencies/train-variables-values.tfvars
iam_policy_arn = [
  "arn:aws:iam::aws:policy/SecretsManagerReadWrite",
  "arn:aws:iam::aws:policy/service-role/AmazonEC2RoleforSSM",
  "arn:aws:iam::aws:policy/CloudWatchAgentServerPolicy"
]
aws_directory_service_directory_id = "d-ssssssssssss" #TBD
aws_kmskey_id                      = ""
fsx_subnets                        = ["subnet-aaaaaaaaaaaaaaaa"]
...
db_name_tag     = "sqldb-app1-prod-001"
db_name_tag_ro  = "repl-sqldb-app1-prod-001"
db_instance_tags = {
  DBType      = "RDS"
  Engine      = "sqlserver-ee"
...
rds_instance_identifier     = "sqldb-app1-prod-001"
rds_instance_identifier_ro  = "repl-sqldb-app1-prod-001"
